 ...
 * @method \App\Model\Entity\Lugare|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Lugare saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
