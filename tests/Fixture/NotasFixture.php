...
class NotasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'factura_id' => ['type' => 'index', 'columns' => ['factura_id'], 'length' => []],
            'user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'notas_ibfk_1' => ['type' => 'foreign', 'columns' => ['factura_id'], 'references' => ['facturas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'notas_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'creado' => '2019-08-11 23:11:26',
                'modificado' => '2019-08-11 23:11:26'
            ],
        ];
        parent::init();
    }
