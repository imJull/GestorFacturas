    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $nota->has('user') ? $this->Html->link($nota->user->nombre, ['controller' => 'Users', 'action' => 'view', $nota->user->id]) : '' ?></td>
                <td><?= h($nota->titulo) ?></td>
                <td><?= h($nota->creado) ?></td>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $nota->id], ['confirm' => __('Desea eliminar # {0}?', $nota->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
